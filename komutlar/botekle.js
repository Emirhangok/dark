...
exports.run = function(client, message, args) {
  ...
  .setColor("PURPLE")
  .setDescription(`<a:emoji_4:890245493240770631> ${message.author} adlı kullanıcının <@${botid}> adlı botu sıraya ekledi. Botu onaylanmayı bekliyor. `)
  ...
  message.channel.send(` <a:emoji_4:890245493240770631> Bot ekleme isteğiniz alındı.`).then(msg => msg.delete(1000))
  }
};
////fiber botlist & code
exports.conf = {
